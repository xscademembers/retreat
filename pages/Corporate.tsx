...
export const Corporate: React.FC = () => {
  return (
    <main id="main-content" className="pt-20 sm:pt-24">
      ...
      <section className="py-16 sm:py-24 lg:py-32 px-4 sm:px-6 lg:px-12 bg-background-soft" aria-labelledby="corp-included-heading">
              ...
              <AnimateOnScroll animation="fade-right">
                <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
                  <div className="bg-primary/5 px-6 py-4 border-b border-gray-100">
                    ...
                    <p className="text-primary/70 text-sm mt-0.5">Corporate enquiries — your escape awaits</p>
                  </div>
