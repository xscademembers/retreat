      ...
      <section id="packages" className="py-16 sm:py-24 lg:py-32 px-4 sm:px-6 lg:px-12 bg-white">
        <div className="max-w-7xl mx-auto">
          <AnimateOnScroll animation="fade-up" className="text-center max-w-2xl mx-auto mb-16">
            <h2 className="text-primary text-sm font-bold uppercase tracking-[0.2em] mb-4">Day Spend Packages</h2>
          ...
          <AnimateOnScroll animation="fade-up">
            <div className="mb-16 flex flex-col md:flex-row md:items-end justify-between gap-6">
              <div className="space-y-4">
                <h2 className="text-primary text-sm font-bold uppercase tracking-[0.2em]">Day Spend Add-Ons</h2>
                <h3 className="text-4xl font-extrabold tracking-tight">Add Rooms to Your Day Spend</h3>
              </div>
              <p className="max-w-md text-gray-500">Add rooms to your day spend package for extra comfort. All add-ons available 11 am to 7 pm. Night stays also available—see prices below.</p>
            </div>
          </AnimateOnScroll>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch">
