  ...
  return (
    <div className={`flex flex-col lg:flex-row items-stretch min-h-[400px] sm:min-h-[500px] xl:min-h-[600px] ${reverse ? 'lg:flex-row-reverse' : ''}`}>
      <div className={`w-full lg:w-1/2 p-6 sm:p-8 lg:p-12 xl:p-24 flex flex-col justify-center ${reverse ? 'bg-white' : 'bg-primary/5'}`}>
        ...
        <p className="text-base sm:text-lg text-primary/70 leading-relaxed mb-8 sm:mb-10 max-w-md">
          {amenity.description}
        </p>
        <a href="#experiences" className="flex items-center gap-4 group w-fit min-h-[44px] py-2">
          <span className="size-11 sm:size-12 rounded-full bg-primary text-white flex items-center justify-center transition-transform group-hover:scale-110 shrink-0">
